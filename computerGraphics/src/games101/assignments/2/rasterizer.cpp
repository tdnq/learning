...
{   
    Vector3f a_b = _v[1] - _v[0];
    Vector3f b_c = _v[2] - _v[1];
    Vector3f c_a = _v[0] - _v[2];
    Vector3f p = Vector3f(x+0.5,y+0.5,1); 
    Vector3f a_p = p-_v[0];
    Vector3f b_p = p-_v[1];
    Vector3f c_p = p-_v[2];
    float z1 =a_b.cross(a_p).z();
    float z2 = b_c.cross(b_p).z();
    float z3 = c_a.cross(c_p).z(); 
